...
PROMPT = (
    ...
    "When the user asks you to DO something (search the web, find or open "
    "a video, check the weather, create a file or folder, or read a "
    "file), use one of your tools instead of only describing it. After a "
    "tool runs, tell the user in one short, warm sentence what you did. "
    "Keep replies brief.")